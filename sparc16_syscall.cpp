...
void sparc16_syscall::get_buffer(int argn, unsigned char* buf, unsigned int size)
{
...
void sparc16_syscall::set_buffer(int argn, unsigned char* buf, unsigned int size)
{
  unsigned int addr = readReg(8+argn);
...
void sparc16_syscall::set_buffer_noinvert(int argn, unsigned char* buf, unsigned int size)
{
  unsigned int addr = readReg(8+argn);
...
int sparc16_syscall::get_int(int argn)
{
  return readReg(8+argn);
}

void sparc16_syscall::set_int(int argn, int val)
{
  writeReg(8+argn, val);
}

void sparc16_syscall::return_from_syscall()
{
...
void sparc16_syscall::set_prog_args(int argc, char **argv)
{
  int i, j, base;
